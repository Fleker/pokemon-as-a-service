...
export const MONTH_THEME = {
  label: "Let's Go Down the Beaten Path",
}
...
const spindaOfTheMonth = Potw(P.Spinda, {var: 4, form: 'g'})
const pumpkabooForm = Potw(P.Pumpkaboo, {var:1, form: 'large'})
const pikachuForm = Potw(P.Pikachu, {var:4, form: 'phd'})
const vivillonForm = Potw(P.Vivillon, {var: 2, form: 'continental'})
// Y -> R -> O -> B -> W
const florgesForm = Potw(P.Florges, {var:4, form: 'yellow'})
const starterBossVar = 1
const grandUndergroundVar = 1
/* eslint-disable @typescript-eslint/no-unused-vars */
const fossils12 = [{
...
export const standardBosses: RaidBoss[][] = [
  ...
  [{
    ...
    species: Potw(P.Mienfoo, {var:4})
  }, {
    species: Potw(P.Riolu, {var:1})
  }, {
    species: Potw(P.Meditite, {var:1})
  }, {
    species: Potw(P.Zigzagoon, {var:4, form: 'galarian'})
  },
  ],
  /* 2-Star */
  [{
    ...
    species: Potw(P.Stufful, {var:1}),
  }, {
    species: Potw(P.Swinub, {var:3}),
  }, {
    species: Potw(P.Mankey, {var:2}),
  }, {
    species: Potw(P.Diglett, {var:4}),
  }, {
    species: Potw(P.Numel, {var:3}),
},  {
  ...
  [{
    ...
    species: Potw(P.Sawk, {var:2})
  }, {
    species: Potw(P.Quagsire, {var:2})
  }, {
    species: Potw(P.Breloom, {var:1})
  }, {
    species: Potw(P.Claydol, {var:2}),
  }, {
    species: spindaOfTheMonth
  }, {
    species: pikachuForm
  ...
  /* 4-Star */
  [{
    species: Potw(P.Machoke, {var:1}),
  }, {
    species: Potw(P.Tauros, {var:1, form: 'combat_breed'})
  }, {
    species: Potw(P.Gurdurr, {var:3})
  }, {
    species: Potw(P.Passimian, {var:2})
  }, {
    species: Potw(P.Crabrawler, {var:1})
  }, {
    species: Potw(P.Poliwrath, {var:3})
  }, {
    species: Potw(P.Palossand, {var:1})
  }, {
    species: Potw(P.Hitmonlee, {var:1}),
  }, {
    species: Potw(P.Hitmonchan, {var:1}),
  }, {
    species: vivillonForm
  }],
  /* 5-Star */
  [{
    species: Potw(P.Falinks, {var:4}),
  }, {
    species: Potw(P.Sandaconda, {var:4}),
  }, {
    species: Potw(P.Infernape, {var:4}),
  }, {
    species: Potw(P.Torterra, {var:4}),
  }, {
    species: Potw(P.Heracross, {var:3}),
  }, {
    species: Potw(P.Garchomp, {var:4}),
  }, {
  ...
  /* 7-Star */
  [...tinyFire, ...hoennEgg, {
    species: Potw(P.Pichu, {var: 3, form: 'spiky'})
  }, {
    species: Potw(P.Pawniard, {var:4})
  }, {
    species: Potw(P.Sizzlipede, {var:4})
  }, {
    species: Potw(P.Wooloo, {var:4})
  }, {
    species: Potw(P.Darumaka, {var:4, form: 'galarian'})
  }, {
    species: Potw(P.Gimmighoul, {var:2, form: 'chest'})
  }, {
    species: Potw(P.Magikarp, {var:1, form: 'orange_white_and_black_calico'})
  }],
  /* 8-Star */
  [
    {
      // Mega
      species: Potw(P.Salamence, {var:1}),
      heldItem: 'salamenceite',
    },
    {
      species: Potw(P.Metagross, {var:3}),
      heldItem: 'metagrossite',
    },
    {
      species: Potw(P.Altaria, {var:3}),
      heldItem: 'altariaite',
    },
    {
      // Z-Electric
      // see https://serebii.net/sunmoon/alolapokedex.shtml
      species: Potw(P.Mudsdale, {var:1}),
      heldItem: 'zgroundium',
    },
    {
      // Special Z-Move
      species: Potw(P.Eevee, {var:4}),
      heldItem: 'zeevium',
    },
    {
      // Totem
    ...
    },
    {
      ...
      species: Potw(P.Arcanine, {var:2, form: 'noble'})
    },
    {
      // Tera Type
      species: Potw(P.Umbreon, {var:2}),
      heldItem: 'teradark',
    },
    {
      // Starmobile
    ...
    {
      // Titan Klawf
      species: Potw(P.Bombirdier, {var:1, form: 'titan'}),
    },
...
export const forecastBoss: {[key in WeatherType]: {[rating: number]: RaidBoss[]}} = {
  Cloudy: {
    ...
    4: [{
      species: Potw(P.Polteageist, {var: 3}),
    }, {
      species: Potw(P.Umbreon, {var: 4}),
    }]
  },
  Fog: {
    3: [{
     species: Potw(P.Misdreavus, {var: 3}),
    }, {
     species: Potw(P.Eevee, {var: 4}),
    }],
    4: [{
      species: Potw(P.Mismagius, {var:3}),
    }, {
      species: Potw(P.Espeon, {var: 4}),
    }]
  },
  'Heat Wave': {
    3: [{
    ...
    4: [{
      ...
      species: Potw(P.Flareon, {var: 4})
    }]
  },
  Rain: {
    3: [{
      species: Potw(P.Psyduck, {var:4}),
    }, {
      species: Potw(P.Eevee, {var: 4}),
    }],
    4: [{
      species: Potw(P.Golduck, {var:4}),
    }, {
      species: Potw(P.Vaporeon, {var: 4}),
    }]
  },
  Sandstorm: {
    3: [{
      species: Potw(P.Bergmite, {var: 3}),
    }, {
      species: Potw(P.Sudowoodo, {var: 2}),
    }],
    4: [{
      species: Potw(P.Avalugg, {var: 3, form: 'hisuian'}),
    }, {
      species: Potw(P.Sudowoodo, {var: 2}),
    }],
  },
  ...
  Thunderstorm: {
    3: [{
      species: Potw(P.Basculin, {var:3, form: 'white_stripe'}),
    }, {
      species: Potw(P.Eevee, {var:4}),
    }],
    4: [{
      species: Potw(P.Basculegion, {var:3}),
    }, {
      species: Potw(P.Jolteon, {var:4}),
    }]
  },
  Sunny: {
    3: [{
      species: Potw(P.Applin, {var: 3}),
    }, {
      species: Potw(P.Eevee, {var: 4}),
    }],
    4: [{
      species: Potw(P.Appletun, {var:3}),
    }, {
      species: Potw(P.Leafeon, {var: 4}),
    }]
  },
  Windy: {
    3: [{
    ...
    4: [{
      species: Potw(P.Flapple, {var:3}),
    }, {
      species: Potw(P.Sylveon, {var: 4}),
    }]
  },
}
...
export const terrainBoss: {[key in TerrainType]: {[rating: number]: RaidBoss[]}} = {
  Bay: {
    2: [{
      species: Potw(P.Piplup, {var: 4})
    }, {
      species: Potw(P.Tympole, {var: 3})
    }],
    3: [{
      species: Potw(P.Prinplup, {var: 4})
    }, {
      species: Potw(P.Palpitoad, {var: 3})
    }],
    4: [{
      species: Potw(P.Empoleon, {var:4})
    }, {
      species: Potw(P.Seismitoad, {var: 3})
    }]
  },
  Beach: {
    2: [{
      species: Potw(P.Pincurchin, {var: 4})
    }, {
      species: Potw(P.Poliwag, {var: 3})
    }],
    3: [{
      species: Potw(P.Pincurchin, {var: 4})
    }, {
      species: Potw(P.Poliwhirl, {var: 3})
    }],
    4: [{
      species: Potw(P.Pincurchin, {var: 4})
    }, {
      species: Potw(P.Politoed, {var: 3})
    }]
  },
  Mountain: {
    2: [{
      species: Potw(P.Slugma, {var:2})
    }, {
      species: Potw(P.Rhyhorn, {var:1})
    }],
    3: [{
      species: Potw(P.Slugma, {var:2})
    }, {
      species: Potw(P.Rhydon, {var:1})
    }],
    4: [{
      species: Potw(P.Magcargo, {var:2})
    }, {
      species: Potw(P.Rhyperior, {var:1})
    }],
  },
  Tropical: {
    2: [{
      species: Potw(P.Paras, {var:2})
    }, {
    ...
    3: [{
      ...
      species: Potw(P.Marowak, {var:4, form: 'alolan'})
    }],
    4: [{
      species: Potw(P.Parasect, {var:2})
    }, {
      species: Potw(P.Marowak, {var:4, form: 'alolan'})
    }],
  },
  Rural: {
    2: [{
      species: Potw(P.Goomy, {var:4})
    }, {
      species: Potw(P.Golett, {var:1})
    }],
    3: [{
      species: Potw(P.Sliggoo, {var:4, form:'hisuian'})
    }, {
      species: Potw(P.Golett, {var:1})
    }],
    4: [{
      species: Potw(P.Goodra, {var:4, form: 'hisuian'})
    }, {
      species: Potw(P.Golurk, {var:1})
    }],
  },
  Desert: {
    2: [{
      species: Potw(P.Sentret, {var:3})
    }, {
      species: Potw(P.Trapinch, {var:2})
    }],
    3: [{
      species: Potw(P.Furret, {var: 3})
    }, {
      species: Potw(P.Vibrava, {var:2})
    }],
    4: [{
      species: Potw(P.Furret, {var: 3})
    }, {
      species: Potw(P.Flygon, {var:2})
    }],
  },
  Grasslands: {
    2: [{
      species: Potw(P.Morpeko, {var: 4})
    }, {
      species: Potw(P.Chespin, {var: 3})
    }],
    3: [{
      species: Potw(P.Morpeko, {var: 4})
    }, {
      species: Potw(P.Quilladin, {var: 3})
    }],
    4: [{
      species: Potw(P.Morpeko, {var: 4})
    }, {
      species: Potw(P.Chesnaught, {var: 3})
    }],
  },
  Gardens: {
    2: [{
      species: Potw(P.Milcery, {var: 3})
    }, {
      species: Potw(P.Igglybuff, {var: 2})
    }],
    3: [{
      species: Potw(P.Milcery, {var: 3})
    }, {
      species: Potw(P.Jigglypuff, {var: 2})
    }],
    4: [{
      species: Potw(P.Alcremie, {var: 3})
    }, {
      species: Potw(P.Wigglytuff, {var: 2})
    }]
  },
  Forest: {
    2: [{
      species: Potw(P.Teddiursa, {var:4})
    }, {
      species: Potw(P.Tepig, {var: 4})
    }],
    3: [{
      species: Potw(P.Teddiursa, {var:4})
    }, {
      species: Potw(P.Pignite, {var: 4})
    }],
    4: [{
      species: Potw(P.Ursaring, {var:4})
    }, {
      species: Potw(P.Emboar, {var: 4})
    }],
  },
  Urban: {
    2: [{
      species: Potw(P.Duraludon, {var:3})
    }, {
    ...
    3: [{
      ...
      species: Potw(P.Hitmontop, {var:2})
    }],
    4: [{
      species: Potw(P.Duraludon, {var:3})
    }, {
  ...
  Rainforest: {
    2: [{
      species: Potw(P.Scyther, {var:4})
    }, {
      species: Potw(P.Bellsprout, {var: 3})
    }],
    3: [{
      species: Potw(P.Scyther, {var:4})
    }, {
      species: Potw(P.Weepinbell, {var: 3})
    }],
    4: [{
      species: Potw(P.Kleavor, {var:4})
    }, {
      species: Potw(P.Victreebel, {var: 3})
    }],
  },
  Oceanic: {
    2: [{
      species: Potw(P.Spheal, {var: 2})
    }, {
      species: Potw(P.Makuhita, {var: 4})
    }],
    3: [{
      species: Potw(P.Sealeo, {var: 2})
    }, {
      species: Potw(P.Makuhita, {var: 4})
    }],
    4: [{
      species: Potw(P.Walrein, {var: 2})
    }, {
      species: Potw(P.Hariyama, {var: 4})
    }],
  }
}
