...
export const specialRaids: BadgeId[] = [
  ...
  Potw(P.Duraludon, {var: 1}),
  Potw(P.Duraludon, {var: 2}),
  Potw(P.Duraludon, {var: 3}),
  Potw(P.Duraludon, {var: 4}),
]
...
const spindaOfTheMonth = Potw(P.Spinda, {var: 4, form: 'c'})
const pumpkabooForm = Potw(P.Pumpkaboo, {var:4, form: 'large'})
const pikachuForm = Potw(P.Pikachu, {var: 3, form: 'pop_star'})
const vivillonForm = Potw(P.Vivillon, {var: 1, form: 'savanna'})
// Y -> R -> O -> B -> W
const florgesForm = Potw(P.Florges, {var: 3, form: 'red'})
...
export const standardBosses: RaidBoss[][] = [
  ...
  [{
    ...
    species: Potw(P.Smeargle, {var: 2})
  }, {
    species: Potw(P.Shieldon, {var: 1})
  }, {
    species: Potw(P.Cranidos, {var: 1})
  }, {
    species: Potw(P.Zigzagoon, {var: 2, form: 'galarian'})
  },
  ],
  /* 2-Star */
  [{
    ...
    species: Potw(P.Inkay, {var: 2}),
  }, {
    species: Potw(P.Doduo, {var: 4}),
  }, {
    species: Potw(P.Solosis, {var: 2}),
  }, {
    species: Potw(P.Exeggcute, {var: 3}),
  }, {
    species: Potw(P.Rhyhorn, {var: 4}),
},  {
  ...
  [{
    ...
    species: Potw(P.Dunsparce, {var: 1})
  }, {
    species: Potw(P.Girafarig, {var: 1})
  }, {
    species: Potw(P.Minccino, {var:3})
  }, {
    species: Potw(P.Golett, {var: 4})
  }, {
    species: Potw(P.Minior, {var: 3}),
  }, {
    species: spindaOfTheMonth
  }, {
    species: pikachuForm
  ...
  /* 4-Star */
  [{
    species: Potw(P.Flygon, {var: 1}),
  }, {
    species: Potw(P.Meowstic, {var: 1})
  }, {
    species: Potw(P.Feraligatr, {var: 3})
  }, {
    species: Potw(P.Meganium, {var:3})
  }, {
    species: Potw(P.Vileplume, {var: 4})
  }, {
    species: Potw(P.Bellossom, {var:4})
  }, {
    species: Potw(P.Zebstrika, {var:3})
  }, {
    species: Potw(P.Toucannon, {var:1}),
  }, {
    species: Potw(P.Lapras, {var:2}),
  }, {
  ...
  [{
    ...
    species: Potw(P.Arctozolt, {var: 1}),
  }, {
    species: Potw(P.Arctovish, {var: 1}),
  }, {
    species: Potw(P.Dracozolt, {var: 1}),
  }, {
    species: Potw(P.Dracovish, {var: 1}),
  }, {
    species: florgesForm,
  }, /* {
  ...
  [
    {
      // Mega
      species: Potw(P.Sceptile, {var: 2}),
      heldItem: 'sceptileite',
    },
    {
      species: Potw(P.Swampert, {var: 3}),
      heldItem: 'swampertite',
    },
    {
      species: Potw(P.Sharpedo, {var: 2}),
      heldItem: 'sharpedoite',
    },
    {
      species: Potw(P.Camerupt, {var: 2}),
      heldItem: 'cameruptite',
    },
    {
      // Z-Electric
      // see https://serebii.net/sunmoon/alolapokedex.shtml
      species: Potw(P.Dugtrio, {var: 4, form: 'alolan'}),
      heldItem: 'zsteelium',
    },
    {
      // Special Z-Move
      species: Potw(P.Eevee, {var: 1}),
      heldItem: 'zeevium',
    },
    {
      // Totem
      // see https://bulbapedia.bulbagarden.net/wiki/Totem_Pok%C3%A9mon
      species: Potw(P.Salazzle, {var: 1, form: 'totem'})
    },
    {
      // GMax
    ...
    },
    {
      ...
      species: Potw(P.Golem, {var: 1, form: 'alpha'})
    },
    {
      // Nobles
      // see https://www.serebii.net/legendsarceus/noblepokemon.shtml
      species: Potw(P.Electrode, {var: 1, form: 'noble'})
    },
...
export const terrainBoss: {[key in TerrainType]: {[rating: number]: RaidBoss[]}} = {
  Bay: {
    2: [{
      species: Potw(P.Vulpix, {var: 3, form: 'alolan'})
    }, {
      species: Potw(P.Seel, {var: 4})
    }],
    3: [{
      species: Potw(P.Vulpix, {var: 3, form: 'alolan'})
    }, {
    ...
    4: [{
      species: Potw(P.Ninetales, {var: 3, form: 'alolan'})
    }, {
      species: Potw(P.Dewgong, {var: 4})
    }]
  },
  Beach: {
    2: [{
      species: Potw(P.Grimer, {var: 3, form: 'alolan'})
    }, {
      species: Potw(P.Chinchou, {var: 2})
    }],
    3: [{
      species: Potw(P.Grimer, {var: 3, form: 'alolan'})
    }, {
    ...
    4: [{
      species: Potw(P.Muk, {var: 3, form: 'alolan'})
    }, {
  ...
  Mountain: {
    2: [{
      species: Potw(P.Scyther, {var: 2})
    }, {
      species: Potw(P.Beldum, {var: 2})
    }],
    3: [{
      species: Potw(P.Scyther, {var: 2})
    }, {
      species: Potw(P.Metang, {var: 2})
    }],
    4: [{
      species: Potw(P.Kleavor, {var: 2})
    }, {
      species: Potw(P.Metagross, {var: 2})
    }],
  },
  Tropical: {
    2: [{
      species: Potw(P.Exeggcute, {var: 2})
    }, {
      species: Potw(P.Litwick, {var: 2})
    }],
    3: [{
      species: Potw(P.Exeggcute, {var: 2})
    }, {
      species: Potw(P.Lampent, {var: 2})
    }],
    4: [{
      species: Potw(P.Exeggutor, {var: 2})
    }, {
      species: Potw(P.Chandelure, {var: 2})
    }],
  },
  Rural: {
    2: [{
      species: Potw(P.Stantler, {var: 1})
    }, {
      species: Potw(P.Jangmo_o, {var: 1})
    }],
    3: [{
      species: Potw(P.Stantler, {var: 1})
    }, {
      species: Potw(P.Hakamo_o, {var: 1})
    }],
    4: [{
      species: Potw(P.Wyrdeer, {var: 1})
    }, {
      species: Potw(P.Kommo_o, {var: 1})
    }],
  },
  Desert: {
    2: [{
      species: Potw(P.Yamask, {var: 2, form: 'galarian'})
    }, {
      species: Potw(P.Mawile, {var: 2})
    }],
    3: [{
      species: Potw(P.Yamask, {var: 2, form: 'galarian'})
    }, {
  ...
  Grasslands: {
    2: [{
      species: Potw(P.Wooloo, {var: 2})
    }, {
      species: Potw(P.Ponyta, {var: 3})
    }],
    3: [{
      species: Potw(P.Wooloo, {var: 2})
    }, {
    ...
    4: [{
      species: Potw(P.Dubwool, {var: 2})
    }, {
      species: Potw(P.Rapidash, {var: 3})
    }],
  },
  Gardens: {
    2: [{
      species: Potw(P.Gossifleur, {var: 2})
    }, {
      species: Potw(P.Kecleon, {var: 1})
    }],
    3: [{
      species: Potw(P.Gossifleur, {var: 2})
    }, {
  ...
  Forest: {
    2: [{
      species: Potw(P.Sizzlipede, {var: 2})
    }, {
      species: Potw(P.Swinub, {var: 2})
    }],
    3: [{
      species: Potw(P.Sizzlipede, {var: 2})
    }, {
      species: Potw(P.Piloswine, {var: 2})
    }],
    4: [{
      species: Potw(P.Centiskorch, {var: 2})
    }, {
      species: Potw(P.Mamoswine, {var: 2})
    }],
  },
  Urban: {
    2: [{
      species: Potw(P.Cutiefly, {var: 3})
    }, {
      species: Potw(P.Porygon, {var: 2})
    }],
    3: [{
      species: Potw(P.Cutiefly, {var: 3})
    }, {
      species: Potw(P.Porygon2, {var:2})
    }],
    4: [{
      species: Potw(P.Ribombee, {var: 3})
    }, {
      species: Potw(P.Porygon_Z, {var: 2})
    }]
  },
  Rainforest: {
    2: [{
      species: Potw(P.Salandit, {var: 4})
    }, {
      species: Potw(P.Karrablast, {var: 3})
    }],
    3: [{
      species: Potw(P.Salandit, {var: 4})
    }, {
    ...
    4: [{
      species: Potw(P.Salazzle, {var: 4})
    }, {
      species: Potw(P.Escavalier, {var: 3})
    }],
  },
  Oceanic: {
    2: [{
      species: Potw(P.Qwilfish, {var: 2, form: 'hisuian'})
    }, {
      species: Potw(P.Feebas, {var: 2})
    }],
    3: [{
      species: Potw(P.Qwilfish, {var: 2, form: 'hisuian'})
    }, {
    ...
    4: [{
      species: Potw(P.Overqwil, {var: 2})
    }, {
      species: Potw(P.Milotic, {var: 2})
    }],
  }
}
