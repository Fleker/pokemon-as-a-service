...
function PaldeaSandwich(label: string, item: Partial<Item>): Item {
  return {
    label, category: 'bait',
...
const ITEMS_INGREDIENTS = {
  ...
  svsuvariety: PaldeaSandwich('Ultra Variety Sandwich', { description: 'A hefty sandwich with a variety of palatable flavors.', sell: 30 }),
  svsutower: PaldeaSandwich('Ultra Tower Sandwich', { description: 'This hefty sandwich does its best to contain its many ingredients.', sell: 30 }),
  svsurefreshing: PaldeaSandwich('Ultra Refreshing Sandwich', { description: 'A hefty sandwich full of rich vegetable flavor.', sell: 30 }),
  svsuegg: PaldeaSandwich('Ultra Egg Sandwich', { description: 'An egg sandwich with a handful of other ingredients to create a rich flavor.', sell: 30 }),
  svscurryrice: PaldeaSandwich('Ultra Curry-and-Rice-style Sandwich', { description: 'A hefty sandwich with a kick of flavor.', sell: 30 }),
  svsumarmalade: PaldeaSandwich('Ultra Marmalade Sandwich', { description: 'A sandwich with a bit of saltiness but otherwise fantastically balanced.', sell: 30 }),
  svsunouveau: PaldeaSandwich('Ultra Nouveau Veggie Sandwich', { description: 'A sandwich that is savory, bitter, and sweet.', sell: 30 }),
  svsuhefty: PaldeaSandwich('Ultra Hefty Sandwich', { description: 'A sandwich full of heavy carbs. Plan for a nap after eating.', sell: 30 }),
  svsubocadillo: PaldeaSandwich('Ultra Classic Bocadillo', { description: 'A fantastic sandwich if you like veggies.', sell: 30 }),
  svsudecadent: PaldeaSandwich('Ultra Decadent Sandwich', { description: 'A delicious and hefty sandwich with only the best ingredients.', sell: 30 }),
  svsuhamburger: PaldeaSandwich('Ultra Hamburger Patty Sandwich', { description: 'A hefty sandwich with a great deal of savory flavor.', sell: 30 }),
  svsucurrynoodle: PaldeaSandwich('Ultra Curry-and-Noodle Sandwich', { description: 'A hefty sandwich stocked to the brim with ingredients.', sell: 30 }),
  svsuzesty: PaldeaSandwich('Ultra Zesty Sandwich', { description: 'A hefty sandwich that, as you bite it, it bites back.', sell: 30 }),
  svslbitter: PaldeaSandwich('Ultra Bitter Sandwich', { description: 'A hefty sandwich which has the bitterest flavor possible.', sell: 30 }),
  svsusushi: PaldeaSandwich('Ultra Sushi Sandwich', { description: 'A sandwich dreamed up by a sushi aficionado. It is stuffed to the brim with flavor.', sell: 30 }),
  svsuklawf: PaldeaSandwich('Ultra Klawf Claw Sandwich', { description: 'A hefty sandwich with great flavors and a dubious crunch.', sell: 30 }),
  svsuspicysweet: PaldeaSandwich('Ultra Spicy-Sweet Sandwich', { description: 'A perfect blend of spicy and sweet flavoring.', sell: 30 }),
  svsublt: PaldeaSandwich('Ultra BLT Sandwich', { description: 'The perfect BLT in every way.', sell: 30 }),
